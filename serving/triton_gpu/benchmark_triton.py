"""
Benchmark script for Triton GPU serving.
Same as triton_cpu/benchmark_triton.py — Triton protocol is the same
regardless of whether the model runs on CPU or GPU.
"""
